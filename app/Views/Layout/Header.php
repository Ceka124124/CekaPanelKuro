<header>
    <nav class="navbar navbar-expand-md navbar-dark bg-white shadow-sm align-middle" role="alert" >
        <div class="container px-3">
            <a class="navbar-brand text-dark" href="<?= site_url() ?>"><img src="https://i.postimg.cc/qRfjPrL2/111-removebg-preview.png" width="50" height="50" alt=""><?= BASE_NAME ?></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <?php if (session()->has('userid')) : ?>
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link text-dark" href="<?= site_url('keys') ?>"> All Keys</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-dark" href="<?= site_url('keys/generate') ?>">Create Key</a>
                        </li>
                                    ...
                                    <?php if ($user->level == 1) : ?>
                                        ...
                                        <li>
                                            ...
                                            <a class="dropdown-item" href="<?= site_url('Server') ?>">
                                             ...
                                             <li>
                                            <a class="dropdown-item" href="<?= site_url('Server') ?>">
                                                <i class="bi bi-controller"></i> Dowload Mod
                                            </a>
                                        </li>
                                        <li>
                                            <hr class="dropdown-divider">
