            ...
            <div class="card-header text-center font-weight-bold text-dark">
                <div class="row">
                    ...
                    <div class="col text-end">
                        <a class="btn btn-sm btn-outline-dark rounded-circle" href="<?= site_url('keys') ?>"><i class="bi bi-people"></i></a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-lg-6 mb-3 ">
                        ...
                        <input type="number" name="max_devices" id="max_devices" class="form-control rounded-pill" placeholder="1" value="<?= old('max_devices') ?: 1 ?>">
                        <?php if ($validation->hasError('game')) : ?>
...
<input class="form-check-input rounded-pill" type="checkbox" minlength="4" maxlength="32" value="" name="check" onchange="fupi(this)" id="check">
<br>


<br>
<label for="custom" id="cuslabel" class="form-label">Type Your Key</label>
    <input type="text" minlength="4" maxlength="32" name="cuslicense" class="form-control rounded-pill" id="custom"></input>
    
 <br>
  <label for="hulala" id="labula" class="form-label">Bulk Keys</label>         
  <select class="form-select rounded-pill" aria-label="Default select example" id="hulala" name="loopcount">
...
<br>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" id="estimation" class="form-control rounded-pill" placeholder="Your order will total" readonly>
                </div>
