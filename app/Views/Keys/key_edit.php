        ...
        <div class="card text-dark bg-gradient-light shadow h-100 py-2">
            <div class="card-body text-center font-weight-bold text-dark h5" >
                <div class="row">
                    ...
                    <div class="col">
                        <div class="text-end">
                            <a class="btn btn-sm btn-outline-light rounded-pill" href="<?= site_url('keys/generate') ?>"><i class="bi bi-person-plus"></i></a>
                            <a class="btn btn-sm btn-outline-light rounded-pill" href="<?= site_url('keys') ?>"><i class="bi bi-people"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <input type="hidden" name="id_keys" value="<?= $key->id_keys ?>">
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="text" name="game" id="game" class="form-control rounded-pill" placeholder="RandomKey" aria-describedby="help-game" value="<?= old('game') ?: $key->game ?>">
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="text" name="user_key" id="user_key" class="form-control rounded-pill" placeholder="RandomKey" aria-describedby="help-user_key" value="<?= old('user_key') ?: $key->user_key ?>">
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="number" name="duration" id="duration" class="form-control rounded-pill" placeholder="3" aria-describedby="help-duration" value="<?= old('duration') ?: $key->duration ?>">
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="number" name="max_devices" id="max_devices" class="form-control rounded-pill" placeholder="3" aria-describedby="help-max_devices" value="<?= old('max_devices') ?: $key->max_devices ?>">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="registrator" id="registrator" class="form-control rounded-pill" placeholder="nata" aria-describedby="help-registrator" value="<?= old('registrator') ?: $key->registrator ?>">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" name="expired_date" id="expired_date" class="form-control rounded-pill" placeholder="<?= $time::now() ?>" aria-describedby="help-expired_date" value="<?= old('expired_date') ?: $key->expired_date ?>">
                    ...
                    <div class="col-lg-12 mb-3">
                        ...
                        <textarea class="form-control rounded-pill" name="devices" id="devices" rows="<?= ($key_info->total > $key->max_devices) ? 3 : $key_info->total ?>"><?= old('devices') ?: ($key_info->total ? $key_info->devices : '') ?></textarea>
