                ...
                <div class="card-body text-dark h5">
                    <div class="row">
                        ...
                        <div class="col text-end">
                            ...
                            <a class="btn btn-outline-danger btn-sm" onclick='return deleteAllKey()' href="<?= site_url('keys/deleteKeys') ?>" input type='submit' value='deleteAllKey'><i class="bi bi-trash-fill"></i>Delete All Keys</a>
                            
                            <a class="btn btn-outline-warning btn-sm"
                            onclick='return resetAll()' href="<?= site_url('keys/resetAll')  ?>" input type='submit' value='resetAll'><i class="bi bi-bootstrap-reboot"></i> Reset All Keys</a>
                            
                            <a class="btn btn-outline-dark btn-sm"
                            onclick='return unusedDelete()' href="<?= site_url('keys/start')  ?>" input type='submit' value='unusedDelete'><i class="bi bi-trash-fill"></i> Un-Used</a>
                            
                            <a class="btn btn-outline-dark btn-sm rounded-pill" href="<?= site_url('keys/generate') ?>"><i class="bi bi-person-plus"></i> KEY</a>
                            
                            <button class="btn btn-secondary btn-sm ms-1 rounded-pill" id="blur-out" data-bs-toggle="tooltip" data-bs-placement="top" title="Eye Protect"><i class="bi bi-eye-slash"></i></button>
                        </div>
                    </div>
                </div>
                <div class="card-body">
