    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $(".generate_qr").click(function() {
                ...
                $(".qr_code").show();
                var num = $(".number").val();
                var link = "upi://pay?pa=aalyanmods68576sania@fam%26am=300%26tn=" + num;
                var upi = "https://i.postimg.cc/wvrt3x1G/photo-2024-08-17-06-33-15.jpg/?size=200x200&data=" + link;
                console.log(upi);
                $(".get_qr").attr("src", upi);
            });
    ...
    <section>
        ...
        <div class="form">
            ...
            <div class="flex m20">
                ...
                <input type="text" name="phone" placeholder="All Games" class="m10 number">
            </div>
            <div class="flex m20">
                <label>Amount*</label>
                <input type="email" name="email" placeholder="0-99" class="m10 email">
            </div>
            <div class="flex m20">
        ...
        <div class="qr_code m20">
            <p>Scan the QR Code with any UPI App and pay the amount then download the Your Key</p>
            ...
            <button onclick="document.location='Copy.php'">Get Key</button>
